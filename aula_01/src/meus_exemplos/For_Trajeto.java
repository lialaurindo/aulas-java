...
public class For_Trajeto {
	...
	public static void main(String[] args) {
		/*
		For: João de 6 anos
		Quando preciso que João faça alguma coisa, incluo mais detalhes para que ele entenda de forma clara e para que o resultado seja aquilo que espero. Ele está dando suas primeiras pedaladas de bicicleta e agora vai tentar sozinho, então explico o caminho que ele irá fazer.
		Digo de onde ele vai começar, até onde ele pode ir, e como ele vai contar.

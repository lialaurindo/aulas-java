...
public abstract class Farmacia {
	...
	/*
	 * Defina pelo menos 5 Atributos relevantes a produtos de uma Farmacia; Método
	 * Construtor com parâmetros; Métodos Get e Set para todos os Atributos da
	 * Classe Farmacia; Método visualizar;
	 * 
	 *
	 *Essa atividade também faz parte das aulas 08 e 09, no estudo de
	 *relacionamentos de classe (herança) e classe abstract.
	 *
	 */
